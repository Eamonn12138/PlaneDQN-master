...
class BrainDQN:
	...
	def createTrainingMethod(self):
		...
		#self.session.run(self.cost)

		#print('cost is : ',self.cost.item())
	...
	def trainQNetwork(self):
		...
		if self.timeStep % 10000 == 0:
			self.saver.save(self.session, 'saved_networks1/' + 'network' + '-dqn', global_step = self.timeStep)
